...
public class BatteryDarkoView extends AbstractBatteryView {
    public static final String TAG = BatteryDarkoView.class.getSimpleName();
    ...
    public BatteryDarkoView(Context context) {
        this(context, null, 0);
    }

    public BatteryDarkoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BatteryDarkoView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDroid = ((BitmapDrawable) getResources().getDrawable(R.drawable.statusbar_battery_darko)).getBitmap();
    }
